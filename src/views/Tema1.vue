...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    Separador 
    #t_1_1.titulo-segundo.mb-4.color-secundario
    ...
    Separador 
    #t_1_2.titulo-segundo.mb-4.color-secundario
    ...
    .row.justify-content-center.align-items-center.mb-2
      ...
      .col-lg-8
        ...
        .cajon.color-secundario.p-4.mb-4
          p.mb-0 Según Florencia (2013), en sus #[i blogs] expresa: “Gracias a la información se puede conceptuar, significar o encontrarle sentido a las cosas que rodean o acontecen en la sociedad, para luego de concebir el conocimiento debido, tomar decisiones”. 
    ...
    Separador 
    #t_1_3.titulo-segundo.mb-4.color-secundario
    ...
    .row.align-items-center.justify-content-center.mb-4
      ...
      Separador 
      #t_1_4.titulo-segundo.mb-4.color-secundario
            ...
            .col-sm-12.col-lg-10
              ImagenInfografica.color-primario
                ...
                .tarjeta.fondo-morado.p-3(x="80%" y="37%" numero="+")
                  p #[b La búsqueda web] o consulta de bases de datos, páginas web, #[i blogs], en la red virtual se ha convertido en técnica de recolección de información por excelencia de toda la sociedad. 


      Separador 
      #t_1_5.titulo-segundo.mb-4.color-secundario
            ...
            .py-2
              ul.lista-ul--color
                li.d-flex
                  ...
                  p.text-white  No cuantifican.
                li.d-flex
                  i.fas.fa-check-circle.color-secundario
                  p.text-white  Poco personal especializado.
      .py-3
          ...
          .col-md.tarjeta.bg-color-1.p-4
            ...
            .py-2
              ul.lista-ul--color
                li.d-flex
                  i.fas.fa-check-circle.color-secundario
                  p.text-white Altos costos.

                li.d-flex
                  i.fas.fa-check-circle.color-secundario
                  p.text-white Mayor tiempo.
                li.d-flex
                  i.fas.fa-check-circle.color-secundario
                  p.text-white No profundiza.

                li.d-flex
                  i.fas.fa-check-circle.color-secundario
                  p.text-white No registra reacciones.
                li.d-flex
                  i.fas.fa-check-circle.color-secundario
                  p.text-white Requiere más personal.
